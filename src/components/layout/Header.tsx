...
export const Header = () => {
  ...
  // Derive active section based on pathname
  ...
  useEffect(() => {
    // Don't track scroll if not on home page
      ...
      <header className="app-header">
        <div className="header-content">
          <div className="header-left" ref={headerLeftRef} onClick={handleLogoClick}>
            <img
              src="/kleverhub_logo_transparent.png"
              alt="Klever Hub"
        ...
        <div className="nav-menu-content">
          ...
          <div className="nav-menu-items">
            <nav className="nav-links">
              <a
                href="/"
                className={`nav-link ${location.pathname === '/' && displayActiveSection === 'home' ? 'active' : ''}`}
                onClick={(e) => {
                  e.preventDefault();
                  if (location.pathname === '/') {
              ...
              <a
                href="#features"
                className={`nav-link ${location.pathname === '/' && displayActiveSection === 'features' ? 'active' : ''}`}
              ...
              <a
                href="#resources"
                className={`nav-link ${location.pathname === '/' && displayActiveSection === 'resources' ? 'active' : ''}`}
              ...
              <a
                ...
                className={`nav-link ${location.pathname === '/' && displayActiveSection === 'getting-started' ? 'active' : ''}`}
