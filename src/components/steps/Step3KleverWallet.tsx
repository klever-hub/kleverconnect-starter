export const Step3KleverWallet = () => (
  <div className="tutorial-section">
    ...
    <div className="step-card">
      ...
      <p>The Klever Extension is your gateway to the Klever blockchain, available for Chrome-based browsers.</p>
      ...
      <ol>
        ...
        <li>Visit the official <a href="https://chromewebstore.google.com/detail/klever-wallet/ifclboecfhkjbpmhgehodcjpciihhmif" target="_blank" rel="noopener noreferrer">Klever Wallet on Chrome Web Store</a></li>
        ...
        <li><strong>Pin the extension:</strong> Click the puzzle piece icon in toolbar → Click the pin next to Klever Wallet</li>
      </ol>
      
      <div className="code-block">
        <code>💡 Tip: Visit <a href="https://klever.io/extension/" target="_blank" rel="noopener noreferrer">klever.io/extension</a> for direct download links</code>
      </div>
      
      <div className="warning-box">
        <strong>⚠️ Security Alert:</strong> Only install from official sources. Beware of fake extensions! Always verify the developer is "Klever.io"
      </div>
    </div>

    <div className="step-card">
      <h3>Create Your Wallet</h3>
      <p>Now let's set up your Klever wallet. You can either create a new one or import an existing wallet.</p>
      ...
      <ol>
        ...
        <li>Create a <strong>strong password</strong> (minimum 8 characters)</li>
        <li>Confirm your password</li>
        <li><strong>CRITICAL:</strong> Write down your 12-word mnemonic phrase on paper</li>
    ...
    <div className="step-card">
      ...
      <ol>
        ...
        <li>Visit the <a href="https://faucet.testnet.klever.finance" target="_blank" rel="noopener noreferrer">Klever Testnet Faucet</a></li>
      ...
      <div className="info-box">
        ...
        <ul>
          <li><strong>Purple header</strong> = Mainnet (real tokens)</li>
          <li><strong>Orange header</strong> = Testnet (test tokens)</li>
          <li><strong>Green header</strong> = Devnet (development)</li>
        </ul>
      </div>
    </div>
    ...
    <div className="step-card">
      ...
      <ol>
        <li>Go back to your dApp at <a href="http://localhost:5173" target="_blank" rel="noopener noreferrer">http://localhost:5173</a></li>
