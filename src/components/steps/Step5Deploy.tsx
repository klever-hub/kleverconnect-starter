...
export const Step5Deploy = () => (
  <div className="tutorial-section">
    ...
    <div className="step-card">
      ...
      <p>Creates optimized files in <code>dist/</code> folder</p>
    ...
    <div className="step-card">
      ...
      <ol>
        <li>Visit <a href="https://app.netlify.com" target="_blank" rel="noopener noreferrer">app.netlify.com</a></li>
        <li>Drag your <code>dist</code> folder to the browser</li>
    ...
    <div className="step-card">
      ...
      <div className="warning-box">
        <strong>📋 Prerequisites:</strong> Install Docker Desktop from <a href="https://www.docker.com/products/docker-desktop" target="_blank" rel="noopener noreferrer">docker.com</a>
      </div>
      ...
      <p>Your app will be available at <a href="http://localhost" target="_blank" rel="noopener noreferrer">http://localhost</a></p>
      
      <h4>Deploy to Cloud:</h4>
      <div className="tabs">
        <div className="tab-content">
          <h5>Google Cloud Run</h5>
          <CodeBlock code={`# Build and push
