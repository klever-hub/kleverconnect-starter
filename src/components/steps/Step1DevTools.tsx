...
export const Step1DevTools = () => (
  <div className="tutorial-section">
    ...
    <div className="step-card">
      ...
      <ol>
        <li>Download VS Code from <a href="https://code.visualstudio.com" target="_blank" rel="noopener noreferrer">code.visualstudio.com</a></li>
    ...
    <div className="step-card">
      ...
      <ol>
        <li>Download Node.js LTS from <a href="https://nodejs.org" target="_blank" rel="noopener noreferrer">nodejs.org</a></li>
      ...
      <div className="info-box">
        ...
        <p>The terminal (also called command line or console) is where you type commands to control your computer.</p>
        <p><strong>How to open it:</strong></p>
        <ul>
          <li><strong>Windows:</strong> Press <code>Win + R</code>, type <code>cmd</code> and press Enter. Or search for "Command Prompt" in Start menu.</li>
          <li><strong>macOS:</strong> Press <code>Cmd + Space</code>, type "Terminal" and press Enter. Or find it in Applications → Utilities.</li>
          <li><strong>Linux:</strong> Press <code>Ctrl + Alt + T</code> or search for "Terminal" in your apps.</li>
        </ul>
      </div>

      <p>In the terminal, type these commands and press Enter after each:</p>
      <CodeBlock code="node --version\nnpm --version" />
      <p>You should see version numbers like <code>v20.x.x</code> and <code>10.x.x</code></p>
    ...
    <div className="step-card">
      ...
      <div className="tabs os-tabs">
        <div className="tab-content">
          <h4>Windows</h4>
          <p>Download from <a href="https://git-scm.com" target="_blank" rel="noopener noreferrer">git-scm.com</a></p>
        </div>
        <div className="tab-content">
          <h4>macOS</h4>
