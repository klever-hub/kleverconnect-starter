...
export const Faucet = () => {
  ...
  const shouldShowFaucet = currentNetwork !== 'mainnet' && address;
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      // Capture modalRef.current for cleanup
      ...
      return () => {
        ...
        // Remove tabindex when unmounting - use captured reference
        if (modalElement) {
          ...
          >
            <div className="faucet-modal" ref={modalRef}>
              ...
              <div className="faucet-content">
                <p className="faucet-description">Request free {currentNetwork} KLV for testing</p>
