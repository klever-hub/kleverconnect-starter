...
export const VideoSchema = () => {
  const structuredData = {
    ...
    description: 'Learn how to build decentralized applications with Klever blockchain using KleverConnect starter kit. Step-by-step guide for Web3 development.',
